...
class GuessContainer(Static):
    ...
    def on_button_pressed(self, event):
        ...
        self.querypost_message(events.Key(key=letter, character=letter))

class InputContainer(Static):
    def compose(self) -> ComposeResult:
        yield Button("Q", id = "bQ")
        yield Button("W", id = "bW")
        yield Button("E", id = "bE")
        yield Button("R", id = "bR")
        yield Button("T", id = "bT")
        yield Button("Y", id = "bY")
        yield Button("U", id = "bU")
        yield Button("I", id = "bI")
        yield Button("O", id = "bO")
        yield Button("P", id = "bP")
        yield Button("A", id = "bA")
        yield Button("S", id = "bS")
        yield Button("D", id = "bD")
        yield Button("F", id = "bF")
        yield Button("G", id = "bG")
        yield Button("H", id = "bH")
        yield Button("J", id = "bJ")
        yield Button("K", id = "bK")
        yield Button("L", id = "bL")
        yield Button("Z", id = "bZ")
        yield Button("X", id = "bX")
        yield Button("C", id = "bC")
        yield Button("V", id = "bV")
